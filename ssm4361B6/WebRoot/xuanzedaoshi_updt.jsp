	...
	<body>
			<form action="updateXuanzedaoshi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.gonghao.value='${xuanzedaoshi.gonghao}';</script>	<script language="javascript">document.form1.xingming.value='${xuanzedaoshi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${xuanzedaoshi.xingbie}';</script>	<script language="javascript">document.form1.kexuanrenshu.value='${xuanzedaoshi.kexuanrenshu}';</script>	<script language="javascript">document.form1.yixuanrenshu.value='${xuanzedaoshi.yixuanrenshu}';</script>	<script language="javascript">document.form1.xuesheng.value='${xuanzedaoshi.xuesheng}';</script>	<script language="javascript">document.form1.lianxifangshi.value='${xuanzedaoshi.lianxifangshi}';</script>	<script language="javascript">document.form1.beizhu.value='${xuanzedaoshi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
