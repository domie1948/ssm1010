	...
	<body>
			<form action="updateGonggaoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.gonggaomingcheng.value='${gonggaoxinxi.gonggaomingcheng}';</script>	<script language="javascript">document.form1.neirong.value='${gonggaoxinxi.neirong}';</script>	<script language="javascript">document.form1.fabushijian.value='${gonggaoxinxi.fabushijian}';</script>	<script language="javascript">document.form1.faburen.value='${gonggaoxinxi.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
