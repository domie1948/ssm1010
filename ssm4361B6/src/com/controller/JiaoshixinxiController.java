...
//	分页查询
	...
	public String jiaoshixinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Jiaoshixinxi jiaoshixinxi, String gonghao, String mima, String xingming, String xingbie, String nianling1,String nianling2, String lianxifangshi, String zhaopian, String beizhu, String kexuanrenshu1,String kexuanrenshu2, String yixuanrenshu1,String yixuanrenshu2){
		...
		if(kexuanrenshu1==null||kexuanrenshu1.equals("")){pmap.put("kexuanrenshu1", null);}else{pmap.put("kexuanrenshu1", kexuanrenshu1);}
		if(kexuanrenshu2==null||kexuanrenshu2.equals("")){pmap.put("kexuanrenshu2", null);}else{pmap.put("kexuanrenshu2", kexuanrenshu2);}
		if(yixuanrenshu1==null||yixuanrenshu1.equals("")){pmap.put("yixuanrenshu1", null);}else{pmap.put("yixuanrenshu1", yixuanrenshu1);}
		if(yixuanrenshu2==null||yixuanrenshu2.equals("")){pmap.put("yixuanrenshu2", null);}else{pmap.put("yixuanrenshu2", yixuanrenshu2);}
	...
	@RequestMapping("jiaoshixinxiList2.do")
	public String jiaoshixinxiList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Jiaoshixinxi jiaoshixinxi, String gonghao, String mima, String xingming, String xingbie, String nianling1,String nianling2, String lianxifangshi, String zhaopian, String beizhu, String kexuanrenshu1,String kexuanrenshu2, String yixuanrenshu1,String yixuanrenshu2){
		if(page==null||page.equals("")){
			page="1";
		}
