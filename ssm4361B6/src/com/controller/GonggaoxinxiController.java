...
//	分页查询
	...
	public String gonggaoxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Gonggaoxinxi gonggaoxinxi, String gonggaomingcheng, String neirong, String fabushijian, String faburen){
		...
		if(gonggaomingcheng==null||gonggaomingcheng.equals("")){pmap.put("gonggaomingcheng", null);}else{pmap.put("gonggaomingcheng", gonggaomingcheng);}
		if(neirong==null||neirong.equals("")){pmap.put("neirong", null);}else{pmap.put("neirong", neirong);}
		if(fabushijian==null||fabushijian.equals("")){pmap.put("fabushijian", null);}else{pmap.put("fabushijian", fabushijian);}
	...
	public String gonggaoxinxiList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Gonggaoxinxi gonggaoxinxi, String gonggaomingcheng, String neirong, String fabushijian, String faburen,HttpServletRequest request){
